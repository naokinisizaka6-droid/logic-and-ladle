        ...
        chart_html: `
            <div class="visualization-container">
                ...
                <div style="height:240px; border-left:2px solid #555; border-bottom:2px solid #555; position:relative; overflow: hidden; margin-top: 20px;">
                    ...
                    <div style="position:absolute; bottom:0; left:0; width:150%; height:0; border-top:3px dashed #E57373; transform: skewY(-15deg); transform-origin:bottom left; pointer-events:none;"></div>
                    <!-- Pure Water -->
                    <div style="position:absolute; bottom:0; left:0; width:150%; height:0; border-top:3px solid #4FC3F7; transform: skewY(-8deg); transform-origin:bottom left; pointer-events:none;"></div>
                    <div style="position:absolute; right:10px; top:80px; color:#E57373; font-weight:bold;">Salt Water</div>
                    <div style="position:absolute; right:10px; top:150px; color:#4FC3F7; font-weight:bold;">Pure Water</div>
